...
VALUES( '후니 머리띠', 8000, 100, 'http://192.168.32.102:8080/uploaded/hoonihead.jpg', '훈민월드의 인기 캐릭터 후니를 모티브로 제작된 머리띠로, 부드러운 착용감과 귀여운 디자인이 특징입니다. 퍼레이드 관람이나 기념 촬영 시 착용하면 더욱 즐거운 추억을 남길 수 있습니다.','굿즈'),
( '미니 머리띠', 8000, 100, 'http://192.168.32.102:8080/uploaded/minihead.jpg', '사랑스러운 미니 캐릭터 디자인의 머리띠로, 핑크 컬러와 리본 포인트가 돋보입니다. 어린이부터 성인까지 부담 없이 착용 가능하며 놀이공원 방문 기념 아이템으로 적합합니다.', '굿즈'),
( '후니 티셔츠', 29000, 100, 'http://192.168.32.102:8080/uploaded/hoonit.jpg', '훈민월드 대표 캐릭터 후니가 프린팅된 티셔츠로, 면 소재를 사용해 착용감이 뛰어납니다. 일상복으로도 활용 가능하며 놀이공원 방문 기념 패션 아이템으로 추천드립니다.', '의류'),
( '미니 티셔츠', 29000, 100, 'http://192.168.32.102:8080/uploaded/minit.jpg', '밝고 귀여운 미니 캐릭터가 돋보이는 티셔츠로, 부드러운 촉감과 깔끔한 디자인이 특징입니다. 커플룩이나 가족 단체복으로도 잘 어울리는 상품입니다.', '의류'),
( '후니미니 키링', 5000, 100, 'http://192.168.32.102:8080/uploaded/keyring.jpg', '후니와 미니 캐릭터가 함께 디자인된 키링으로, 가방이나 열쇠에 간편하게 부착할 수 있습니다. 작은 소품이지만 훈민월드의 추억을 오래 간직할 수 있는 아이템입니다.', '액세서리'),
( '후니미니 가방', 5000, 100, 'http://192.168.32.102:8080/uploaded/bag.jpg', '훈민월드 캐릭터 후니미니가 프린팅된 가방으로, 가볍고 실용적인 수납공간을 제공합니다. 놀이공원 내 이동이나 기념품 보관용으로 사용하기 좋습니다.', '가방'),
( '후니미니 퍼레이드 인형', 25000, 100, 'http://192.168.32.102:8080/uploaded/parade.jpg', '퍼레이드 의상을 입은 후니미니 인형으로, 훈민월드 퍼레이드의 즐거운 분위기를 그대로 담아낸 상품입니다. 아이 선물이나 컬렉션용으로 인기가 높습니다.', '인형'),
( '후니미니 인형', 22000, 100, 'http://192.168.32.102:8080/uploaded/doll.jpg', '후니와 미니의 기본 모습을 담은 인형으로, 부드러운 촉감과 안정적인 마감이 특징입니다. 남녀노소 모두에게 사랑받는 훈민월드 대표 캐릭터 상품입니다.', '인형'),
( '후니미니 휴대폰 케이스', 18000, 100, 'http://192.168.32.102:8080/uploaded/phone.jpg', '놀이공원 배경과 후니미니 캐릭터가 함께 디자인된 휴대폰 케이스로, 일상 속에서도 훈민월드의 감성을 느낄 수 있습니다. 기종별 호환을 고려해 제작되었습니다.', '전자기기'),
( '후니미니 그립톡', 8000, 100, 'http://192.168.32.102:8080/uploaded/griptok.jpg', '후니미니 캐릭터가 디자인된 그립톡으로, 스마트폰 사용 시 안정적인 그립감을 제공합니다. 귀여운 디자인과 실용성을 동시에 갖춘 인기 상품입니다.', '액세서리'),
( '후니미니 지비츠', 13000, 100, 'http://192.168.32.102:8080/uploaded/jibbitz.jpg', '후니미니와 훈민월드를 테마로 한 다양한 디자인의 지비츠 세트입니다. 신발이나 가방을 개성 있게 꾸밀 수 있어 어린이와 청소년에게 특히 인기가 많습니다.', '굿즈');
