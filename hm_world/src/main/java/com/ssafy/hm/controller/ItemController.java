...
public class ItemController {
	...
	@Operation(summary = "상품 카테고리 변경")
	public ResponseEntity<?> updateCategory(@PathVariable Integer itemId, @RequestBody Item item) {
		item.setItemId(itemId);

		boolean updated = itemService.updateCategory(item);
